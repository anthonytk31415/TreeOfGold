...
public class EnemyMove {
    ...
    // the gameObject target character; this probably should be the position

    public EnemyMove(GameManager instance, GameObject character, Coordinate posUnit, Coordinate posTarget, bool attack)
    {
    ...
    {
        return $"Character: {character}, posUnit: {posUnit}, posTarget: {posTarget}, attack: {attack}";
    }
